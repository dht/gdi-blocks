    ...
    normal: {
        ...
        extra: {
            aboutDataset: [
                {
                id:'g1',
                imageUrl:'https://livedemo00-joomla.template-help.com/joomla_prod-23811/images/testimonials/testimonials-1.jpg',
                name:'Tom Cooper',
                jobTitle:'Designer',
            ...
            {
                id:'g2',
                imageUrl:'https://livedemo00-joomla.template-help.com/joomla_prod-23811/images/testimonials/testimonials-2.jpg',
                name:'Arsen Akopyan, Russia',
                jobTitle:'Designer',
                description:'Roughly a year ago I decided to found a restaurant in Moscow. You know, there is a big infighting in this sphere. company business-creation program became my salvation. I had got many valuable lessons there and tried to embody them. As a result, my restaurant is one of the most popular and successful in Russia.'
            },
            {
                id:'g3',
